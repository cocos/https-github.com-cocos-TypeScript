...
const ts = require('@cocos/typescript');
...
test.serial('warns for invalid module types', async (t) => {
  ...
  t.is(warning.plugin, '@cocos/typescript');
  t.is(warning.pluginCode, 'TS6046');
  t.is(warning.message, `[plugin @cocos/typescript] @cocos/rollup-plugin-typescript TS6046: Argument for '--module' option must be: 'none', 'commonjs', 'amd', 'system', 'umd', 'es6', 'es2015', 'es2020', 'es2022', 'esnext', 'node16', 'nodenext'.`);
  ...
  //     plugin: 'typescript',
  //     pluginCode: 'TS6046',
  //     message: `@cocos/rollup-plugin-typescript TS6046: Argument for '--module' option must be: 'none', 'commonjs', 'amd', 'system', 'umd', 'es6', 'es2015', 'es2020', 'es2022', 'esnext', 'node16', 'nodenext'.`
  //   }
  // ]);
});
...
//   t.is(caughtError.message, '@cocos/rollup-plugin-typescript TS1110: Type expected.');
...
test.serial('ignore type errors if noEmitOnError is false', async (t) => {
  ...
  t.is(warnings[0].plugin, '@cocos/typescript');
  t.is(warnings[0].pluginCode, 'TS1110');
  t.is(warnings[0].message, '[plugin @cocos/typescript] fixtures/syntax-error/missing-type.ts (1:8): @cocos/rollup-plugin-typescript TS1110: Type expected.');
...
test.serial('should throw on bad options', async (t) => {
  ...
  await t.throwsAsync(
    ...
    {
      message: "[plugin @cocos/typescript] @cocos/rollup-plugin-typescript: Couldn't process compiler options"
    }
  );
  ...
  t.is(warning.message, "[plugin @cocos/typescript] @cocos/rollup-plugin-typescript TS5023: Unknown compiler option 'foo'.");
  ...
  //     plugin: 'typescript',
  //     pluginCode: 'TS5023',
  //     message: `[plugin @cocos/typescript] @cocos/rollup-plugin-typescript TS5023: Unknown compiler option 'foo'.`
  //   }
  // ]);
});
